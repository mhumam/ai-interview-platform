...
class Session < ApplicationRecord
  ...
  # SEEDED FAULT: deliberately reverted to the pre-fix behavior to prove the
  # F1 regression spec actually catches this. See assessment/05 for the
  # revert that follows immediately after in git history.
  def invite_url
